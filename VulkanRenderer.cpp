...
int VulkanRenderer::init(GLFWwindow * newWindow)
{
	...
	try {
		...
		uboViewProjection.projection = glm::perspective(glm::radians(45.0f), (float)swapChainExtent.width / (float)swapChainExtent.height, 0.5f, 80.0f);
		uboViewProjection.view = glm::lookAt(glm::vec3(0.0f, 14.0f, 1.45f), glm::vec3(0.0f, -1.0f, 1.5f), glm::vec3(0.0f, 10.0f, 0.0f));

		uboViewProjection.projection[1][1] *= -1;

		// Create our default "no texture" texture
		createTexture("plain2.png");
	}
...
void VulkanRenderer::recordCommands(uint32_t currentImage)
{
	...
	clearValues[1].color = { 0.38f, 0.68f, 0.95f, 1.0f };
